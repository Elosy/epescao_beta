...
class CameraFragment : Fragment() {
    ...
    /** Volume down or up button receiver used to trigger shutter */
    private val volumeDownUpReceiver = object : BroadcastReceiver() {
    ...
    override fun onDestroyView() {
        ...
        broadcastManager.unregisterReceiver(volumeDownUpReceiver)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        broadcastManager.registerReceiver(volumeDownUpReceiver, filter)
